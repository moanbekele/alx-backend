...
class LFUCache(BaseCaching):
    """A LFU (least frequently used) data structure that stores
    data in a dictionary, and removes the item that has been accessed
    the least frequently when the limit is reached.
    """
    def __init__(self):
